...
def main():
    ...
    url = "https://letterboxd.com/film/the-red-spectacles/"
    print(lbf.get_nth_genre(url, 0))
    
    file_loc = "/Users/martinreid/Desktop/Personal_Coding/Python/letterboxd-dialectica972/watched_test.csv"
